    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                ...
                <a href="home"><img src="assets/img/logo-dark.png" alt="Klorofil Logo"
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="#" class="active"><i class="lnr lnr-book"></i> <span>API
                                    Documentation</span></a></li>
                        <li><a href="logout" class=""><i class="lnr lnr-power-switch"></i>
        ...
        <div class="main">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <h4 class="page-title">API burga adalah sebuah backend yang digunakan untuk mendapatkan data dari
                        database, dan API ini bisa digunakan hanya oleh tim developer burga .Corp saja. Dan untuk token
                        bisa didapatkan pada halaman <a href="home"><code>home</code></a>. Dan API ini hanya bisa
                        digunakan untuk akses internal perusahaan</h4>
